...
//        Task Prime;
//        List<Task> MainRays = new List<Task>();
...
//                    Task t = new Task(delegate { Calculate(T); });
//                    t.Start();
//                    MainRays.Add(t);
//                }
//            }
//            else
//            {
//                Prime = new Task(delegate { this.Calculate_Conv(_processorCt, Rnd.Next()); });
//                Prime.Start();
//            }
//        }
...
//        {
//            List<Task> LastRays = new List<Task>();
//            List<Point> Start;
//            List<double> leg;
//            List<int> code;
